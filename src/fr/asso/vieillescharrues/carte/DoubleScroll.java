 ...
 * containing the entire conte2nts to scroll; this child may itself be a layout
 ...
 */
public class DoubleScroll extends FrameLayout {
    ...
    public DoubleScroll(Context context) {
        this(context, null);
    }

    public DoubleScroll(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.scrollViewStyle);
    }

    public DoubleScroll(Context context, AttributeSet attrs, int defStyle) {
